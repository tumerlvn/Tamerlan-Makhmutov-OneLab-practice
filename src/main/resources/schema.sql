...
CREATE TABLE IF NOT EXISTS tickets(id INT PRIMARY KEY AUTO_INCREMENT, customer_id INT, flight_id INT, seatNumber INT, baggageAmount INT, seatClass ENUM('first', 'econom'), cost FLOAT);